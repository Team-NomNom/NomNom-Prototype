...
namespace SingularityGroup.HotReload.Editor {
    ...
    internal class HotReloadRunTab : HotReloadTabBase {
        ...
        private bool Downloading => DownloadProgress < 1f;
        ...
        void OnGUICore() {
            ...
            var renderConsumptions = _running && !Starting && _status?.isLicensed != true && _status?.isFree != true;
            ...
            if (Downloading || Starting || _status != null && (_status.isLicensed || !_status.freeSessionFinished) && !HotReloadPrefs.FirstLogin) {
                RenderProgressBar();
            }
        ...
        public override void Update() {
            ...
            if(Downloading && Time.time - lastRepaint > 0.25f) {
        ...
        private void RenderStart() {
            ...
            if (_startupProgress != null || _running || Downloading) {
                return;
            }
            EditorGUILayout.Space();
