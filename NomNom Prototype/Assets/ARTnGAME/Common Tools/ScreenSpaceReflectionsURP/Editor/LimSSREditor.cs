using Artngame.LUMINA.LimWorks.Rendering.URP.ScreenSpaceReflections;
...
namespace Artngame.LUMINA.LimWorksEditor.Rendering.ScreenSpaceReflections
{
    ...
    public class LimSSREditor : Editor
    {
        ...
        private SerializedProperty m_scaleHorizon;
        ...
        private SerializedProperty m_useUnsafePass;
        private struct Styles
        {
            ...
            public static GUIContent horizon = EditorGUIUtility.TrTextContent("horizon Scale", "horizon Scale.");
            ...
            public static GUIContent UseUnsafePass = EditorGUIUtility.TrTextContent("use Unsafe Pass", "use Unsafe Pass");
        }
        void Init()
        {
            ...
            m_scaleHorizon = settings.FindPropertyRelative("scaleHorizon");
            ...
            m_useUnsafePass = settings.FindPropertyRelative("useUnsafePass");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_TracingMode.enumValueIndex == 0) {
                ...
                EditorGUILayout.PropertyField(m_scaleHorizon, Styles.horizon);
                ...
                EditorGUILayout.PropertyField(m_useUnsafePass, Styles.UseUnsafePass);
            }
            else
            {
