...
namespace Artngame.LUMINA
{
    ...
    [CustomEditor(typeof(LUMINA))]
    public class LUMINAEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showAdvancedTools)
            {
                ...
                //v1.7
                EditorGUILayout.PropertyField(colorizeVolume, new GUIContent("Use BiRP Renderer", "Use Native URP"));
                EditorGUILayout.PropertyField(helperRendererID, new GUIContent("Helper Renderer ID", "Renderer with Render Objects using SEGI Materials"));
                EditorGUILayout.PropertyField(voxelizerID, new GUIContent("voxelizer Renderer ID", "Renderer with Render Objects using the Vozelize shader"));
                EditorGUILayout.PropertyField(bouncerID, new GUIContent("Bouncer Renderer ID", "Renderer with Render Objects using the Bounce shader"));
