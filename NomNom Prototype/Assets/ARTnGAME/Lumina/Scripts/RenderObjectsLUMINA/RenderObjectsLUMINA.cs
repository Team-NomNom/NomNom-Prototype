...
namespace Artngame.LUMINA
{
  ...
  //  [URPHelpURL("renderer-features/renderer-feature-render-objects")]
    public class RenderObjectsLUMINA : ScriptableRendererFeature
    {
        /// <summary>
        ...
        public class RenderObjectsSettings
        {
            ...
            //public Texture3D threeDTexture;
        }
        ...
        RenderObjectsPassLUMINA renderObjectsPass;
        ...
        public override void Create()
        {
            ...
            renderObjectsPass = new RenderObjectsPassLUMINA(settings.passTag, settings.Event, filter.PassNames,
            ...
            switch (settings.overrideMode)
            {
                ...
                case RenderObjectsSettings.OverrideMaterialMode.Shader:
                    renderObjectsPass.overrideMaterial = null;
                    renderObjectsPass.threeDTexture = settings.threeDTexture;
