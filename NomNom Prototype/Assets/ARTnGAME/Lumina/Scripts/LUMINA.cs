...
//#endif
    ...
    {
        //v1.7
        public int voxelizerID = 2;
        public int bouncerID = 3;
        ...
        void Init()
        {
            ...
            voxelizationShader = Shader.Find("SEGI/SEGIVoxelizeScene");
            voxelTracingShader = Shader.Find("SEGI/SEGITraceScene");
        ...
        void ExecuteBeforeCameraRender(ScriptableRenderContext context, Camera camera) //void OnPreRender()
        {
            ...
            if (renderState == RenderState.Voxelize)
            {
                ...
                if (!colorizeVolume)
                {
                    ...
                    Shader.SetGlobalVector("_CutoffGI", cutoff); //v1.6a
